...
<body>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    while ($result = mysqli_fetch_assoc($data)) {
                        ...
                        <td><a href='voter_req_delete.php?id=$result[id]' class='del' onClick='return delconfirm()'><i class='fa-solid fa-trash-can'></i> Delete</a>
                            
                            <a href='voter_req_accept.php?id=$result[id]' class='edit' onClick='return acceptconfirm()'><i class='fa fa-check-circle'></i> Accept</a>
                        </td>
    ...
    <script>
        ...
        function acceptconfirm() {
            return confirm('Accept this Voter request?');
        }
    </script>
</body>
